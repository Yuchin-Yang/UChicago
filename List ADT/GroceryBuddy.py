...
class GroceryApp:
    ...
    def __init__(self, list):
        ...
        self.addPic.setTextColor("white")
        ...
        self.addNum.setTextColor("white")
        ...
        self.updateNum.setTextColor("white")
...
#                item.image = "default.ppm"
    ...
    def run(self):
        ...
        # Click remove: if anything highlighted, remove it
          ...
          if self.selected >= self.list._size:
            self.dehighlight()
            self.selected = -1
          elif self.selected > -1 and self.selected < self.length:
              self.dehighlight()
              try:
    ...
    def dehighlight(self):
        ...
        if self.selected > -1 and self.selected < self.length:
            ...
            self.rects[self.selected].setFill("light grey")
